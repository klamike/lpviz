...
export function buildConstraintDerivation(points: Vertices, closed: boolean, tol = 1e-6): ConstraintDerivation {
  ...
  for (let index = 0; index < edgeCount; index++) {
    ...
    if (interiorPoint && normalizedA * interiorPoint[0] + normalizedB * interiorPoint[1] > normalizedC + tol) {

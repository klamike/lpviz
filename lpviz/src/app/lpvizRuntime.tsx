...
export type RegisterLpvizRuntimeActions = (actions: LpvizRuntimeActions) => () => void;
...
const LpvizRuntimeActionsContext = createContext<LpvizRuntimeActions | null>(null);
const RegisterLpvizRuntimeActionsContext = createContext<RegisterLpvizRuntimeActions | null>(null);
...
export function LpvizRuntimeProvider({ children }: PropsWithChildren) {
  ...
  const registerRuntimeActions = useCallback<RegisterLpvizRuntimeActions>((actions) => {

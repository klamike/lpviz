...
export function combinedRotationMatrix(angles) {
...
export function perspectiveProject(point3d, focalDistance) {
...
export function transform2DTo3DAndProject(point, viewAngles, focalDistance) {
...
export function inverseTransform2DProjection(projectedPoint2d, viewAngles, focalDistance) {
  const rotationMatrix = combinedRotationMatrix(viewAngles);

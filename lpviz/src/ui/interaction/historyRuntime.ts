import { getState, mutate, type HistoryEntry, type State } from "../../state/store";
...
export function createHistoryRuntime({
  ...
  const captureEntry = (state: Pick<State, "vertices" | "objectiveVector" | "completionMode">): HistoryEntry => ({

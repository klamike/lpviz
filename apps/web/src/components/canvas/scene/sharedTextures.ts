...
/** Globally-shared canvas texture for circular point sprites. */
export const SHARED_CIRCLE_TEXTURE = createCircleTexture();

/** Globally-shared canvas texture for square point sprites. */
export const SHARED_SQUARE_TEXTURE = createSquareTexture();

/** Globally-shared canvas texture for star point sprites. */

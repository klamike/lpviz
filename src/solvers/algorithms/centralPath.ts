...
import type { Lines, VecN, VecNs, Vertices } from "../../lib/math/blas";
import {
  dot,
  infinityNorm,
  linesToDenseAb,
...
import { findStrictFeasiblePoint } from "../../polytope/feasibleRegion";
import { centroid } from "../../polytope/polygon";
